...
const NEED_FAKE_BACKEND = new Set(['genericcheck.cjs', 'bodegacheck.cjs', 'capabilitycheck.cjs', 'genericpersonalitycheck.cjs', 'catalogpersonalitycheck.cjs', 'titlecheck.cjs']);
